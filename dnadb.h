...
private:
    ...
    ******************************************/
    ...
    int quadProbing(int hashKey, int tableCapacity);
    int quadProbingRemove(int hashKey, int tableCapacity, DNA dna);
    bool inOldList(string sequence, int location, int tableCapacity);
    bool inCurrList(string sequence, int location, int tableCapacity);
    string returnDNASequence(DNA dna);
    int returnDNALocation(DNA dna);
    void createNewTable();
    int twentyFiveHelper();
    bool hash();
    void checkOld();
