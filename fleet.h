...
private:
    ...
    // ***************************************************
    void printShips(Ship* aShip) const;
    bool iteratorID(Ship* aShip, int IDnum) const;
    bool checkID(Ship* aShip, int IDnum);
    void iteratorLost(Ship* aShip);
    void treeDestructor(Ship* aShip);
    Ship* insertRecurser(Ship* oldShip, Ship* newShip);
    Ship* removeRecurser(Ship* oldShip, int IDnum);
    Ship* minNodeFinder(Ship* aShip);
    int height(Ship* aShip);
    Ship* rotateRight(Ship* aShip);
    Ship* rotateLeft(Ship* aShip);
